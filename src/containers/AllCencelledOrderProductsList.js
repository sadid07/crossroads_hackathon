...
class AllCencelledOrderProductsList extends React.Component {
    state = {
        loading: false,
        error: null,
        data: null
    ...
    handleFetchItem = () => {
        ...
        authAxios
            .get(`${endpoint}/allcencelledorderproductslistview/`)
                                        ...
                                        data.map(p => {
                                            return (
                                                <Table.Row key={p.id}>
                                                    ...
                                                    {/* <Table.Cell style={{ textAlign: "center" }}> <NavLink to={(`/ordercancellerandreturns/${p.id}`)} >{p.user_returns_status}</NavLink></Table.Cell> */}

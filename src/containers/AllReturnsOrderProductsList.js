...
class AllReturnsOrderProductsList extends React.Component {
    state = {
        loading: false,
        error: null,
        data: null
    ...
    handleFetchItem = () => {
        ...
        authAxios
            .get(`${endpoint}/allreturnsorderproductslistview/`)
            .then(res => {

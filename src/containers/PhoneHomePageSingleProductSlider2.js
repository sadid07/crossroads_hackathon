...
class PhoneHomePageSingleProductSlider2 extends Component {
    ...
    componentDidMount() {
        ...
        axios
            .get(`${endpoint}/PhoneHomePageSingleProductSlider2ListView/`)
...
export default PhoneHomePageSingleProductSlider2;

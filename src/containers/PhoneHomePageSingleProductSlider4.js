...
class PhoneHomePageSingleProductSlider4 extends Component {
    ...
    componentDidMount() {
        ...
        axios
            .get(`${endpoint}/PhoneHomePageSingleProductSlider4ListView/`)
...
export default PhoneHomePageSingleProductSlider4;

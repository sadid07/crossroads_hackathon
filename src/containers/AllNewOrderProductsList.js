...
class AllNewOrderProductsList extends React.Component {
    state = {
        loading: false,
        error: null,
        data: null
    ...
    handleFetchItem = () => {
        ...
        authAxios
            .get(`${endpoint}/allneworderproductslistview/`)
                                        ...
                                        data.map(p => {
                                            return (
                                                <Table.Row key={p.id}>
                                                    ...
                                                    {/* <Table.Cell style={{ textAlign: "center" }}> <NavLink to={(`/ordercanclledstatuschange/${p.id}`)} >{p.user_cancelled_status}</NavLink></Table.Cell> */}
                                                    <Table.Cell style={{ textAlign: "center" }}>
                                        ...
                                        data.map(p => {
                                            return (
                                                <Table.Row key={p.id}>
                                                    ...
                                                    <Table.Cell > Order ID : {p.order_code}</Table.Cell>
                                                    {/* <Table.Cell style={{ textAlign: "center" }}>{p.user_cancelled_status}</Table.Cell> */}
                                                    <Table.Cell >Date : 2020-12-10</Table.Cell>

                                                    {/* <Table.Cell style={{ textAlign: "center" }}> <NavLink to={(`/ordercanclledstatuschange/${p.id}`)} >{p.user_cancelled_status}</NavLink></Table.Cell> */}
                                                    <Table.Cell >
                                                        <NavLink to={(`/ordercanclledstatuschange/${p.id}`)} style ={{textDecoration:'none',color:'black'}}>
                                                            Cancelled : <button type="button" class="btn btn-outline-secondary">Cancelled</button>
                                                        </NavLink>
                                                    </Table.Cell>

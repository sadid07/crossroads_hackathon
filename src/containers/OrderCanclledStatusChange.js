...
class OrderCanclledStatusChange extends React.Component {
    state = {
        loading: false,
        error: null,
        data: '',
    ...
    handleChange = e => {
        const { formData,active } = this.state;
        ...
        if (typeof (formData.cancelled_reason_sms) == "undefined") {
            this.setState({
            ...
            if ((formData.cancelled_reason_sms.length) > 1){
                this.setState({
                    active: false
                });
            }
    ...
    handleFetchItem = () => {
        ...
        axios
            .get(`${endpoint}/ordercancelledandreturnsdetail/${params.ordercanclledstatuschangeID}/`)
    ...
    handleFetchChangeApply = () => {
        ...
        axios
            .put(`${endpoint}/ordercancelledandreturns/${params.ordercanclledstatuschangeID}/`, { ...formData})
            .then(res => {
                        ...
                        <div className='col-md-9 order__hidden__desktop'>
                                ...
                                <Table.Body>
                                    ...
                                    <Table.Row key={item.id}>
                                        ...
                                        <Table.Cell style={{ textAlign: "center" }}>
                                            ...
                                            <select
                                                class="form-select form-select-lg mb-3" aria-label=".form-select-lg example"                                                value={item.user_cancelled_status}
                                                name="user_cancelled_status"
                                                onChange={this.handleChange}
                                            > Choose your option
                                            <option value='Wrongsize / color / etc'>Wrong size / color/etc </option>
                            ...
                            <div class="mb-3">
                                <Form  >
                                    ...
                                    <h4 for="exampleFormControlTextarea1" class="form-label" required>Additional Information (mandatory)</h4>
                                    <textarea class="form-control" id="exampleFormControlTextarea1" rows="3"
                                        name="cancelled_reason_sms"
                                        onChange={this.handleChange}
                                        placeholder= 'This text is requirement'

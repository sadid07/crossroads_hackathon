...
class PhoneHomePageSingleProductSlider5 extends Component {
    ...
    componentDidMount() {
        ...
        axios
            .get(`${endpoint}/PhoneHomePageSingleProductSlider5ListView/`)
...
export default PhoneHomePageSingleProductSlider5;

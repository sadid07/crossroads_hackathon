                                                    ...
                                                    {(() => {
                                                        if (p.status == 'New') {
                                                                ...
                                                                <>
                                                                    <Table.Cell>
                                                                        <NavLink to={(`/ordercanclledstatuschange/${p.id}`)} style={{textDecoration:"none", color:'black'}}>
                                                                            Manage : <button type="button" class="btn btn-outline-secondary"> Cancelled</button>
                                                                        </NavLink> 
                                                                    </Table.Cell>
                                                            ...
                                                            return (
                                                                <>
                                                                {/* <Table.Cell style={{ textAlign: "center" }}><NavLink to={"#"}>{p.user_returns_status}</NavLink> </Table.Cell> */}
                                                                    <Table.Cell><NavLink to={(`/orderreturnstatuschange/${p.id}`)} style={{ textDecoration: "none", color: 'black' }}>
                                                                        Manage : <button type="button" class="btn btn-outline-secondary">Returns</button>
                                                                    </NavLink> </Table.Cell>
                                                            </>
                                                            ...
                                                            return (
                                                                <>
                                                                    <Table.Cell >  Manage : {p.status}</Table.Cell>
                                                                    {/* <Table.Cell style={{ textAlign: "center" }}><NavLink to= {(`/orderreturnstatuschange/${p.id}`)}>
                                                                    <button type="button" class="btn btn-outline-secondary">Returns</button>
                                                                    </NavLink> </Table.Cell> */}
                                                            </>
